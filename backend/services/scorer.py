...
def score_build(character_data: dict[str, Any]) -> dict[str, Any]:
    """Return a lightweight build score that can later be swapped for AI analysis."""
    ...
    if crit_rate < 60:
        score -= min(25, (60 - crit_rate) * 0.9)
        analysis.append("CRIT Rate is below the ideal 60–80 range")
    elif crit_rate > 80:
        score -= min(18, (crit_rate - 80) * 0.7)
    ...
    return {"score": clamp_score(score), "analysis": analysis}
