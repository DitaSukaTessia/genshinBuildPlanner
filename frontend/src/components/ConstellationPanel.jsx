export function ConstellationPanel({ constellations }) {
  return (
    <section className="rounded-[1.8rem] border border-white/8 bg-white/[0.04] p-4">
      <p className="text-[11px] uppercase tracking-[0.24em] text-[#b9bed6]/55">Constellations</p>
      <div className="mt-4 grid grid-cols-2 gap-3">
        {constellations.map((constellation) => (
          <div className="relative flex aspect-square items-center justify-center overflow-hidden rounded-full border border-emerald-300/30 bg-[#1f5f5a]/35 shadow-[0_12px_32px_rgba(25,116,103,0.25)]" key={constellation.label}>
            <img
            ...
            <span className="absolute text-[3rem] font-semibold leading-none text-white drop-shadow-[0_4px_20px_rgba(0,0,0,0.55)]">
